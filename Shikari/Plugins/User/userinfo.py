...
from Shikari.__help__ import STATS, USER_INFO
import Shikari.Database.userinfo_sql as sql
from Shikari.Plugins.disable import DisableAbleCommandHandler
from Shikari.Database.global_bans_sql import is_user_gbanned
from Shikari.Database.afk_sql import is_afk, check_afk_status
from Shikari.Database.users_sql import get_user_num_chats
from Shikari.Handlers.validation import sudo_plus, user_admin, support_plus
from Shikari.Handlers.extraction import extract_user
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/The_SHIKARI_Network">?</a>]'.format(
            bot.username
        )
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/The_SHIKARI_Network)
"""
__mod_name__ = "Infos"
