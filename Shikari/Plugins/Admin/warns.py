...
import telegram
from Shikari import INSPECTOR, REQUESTER, dispatcher
from Shikari.Plugins.disable import DisableAbleCommandHandler
from Shikari.Handlers.validation import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from Shikari.Handlers.extraction import (
    extract_text,
    extract_user,
...
from Shikari.Handlers.string_handling import split_quotes
from Shikari.Plugins.Admin.log_channel import loggable
from Shikari.Database import warns_sql as sql
