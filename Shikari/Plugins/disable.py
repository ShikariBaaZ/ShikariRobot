...
from Shikari.Handlers.managers import CMD_STARTERS, SpamChecker
from Shikari.Handlers.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from Shikari.Database import disable_sql as sql
