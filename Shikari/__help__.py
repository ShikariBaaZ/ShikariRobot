import importlib, re
from Shikari import dispatcher, ALLOW_EXCL, LOGGER
from telegram import InlineKeyboardButton, InlineKeyboardMarkup, ParseMode, Update
from Shikari.Handlers.misc import paginate_modules
from telegram.error import BadRequest
from telegram.ext import CallbackContext
from telegram.utils.helpers import escape_markdown
from Shikari.Handlers.validation import is_user_admin
from telegram.ext.dispatcher import DispatcherHandlerStop
from os.path import isfile


HELP_STRINGS = """Hey there! My name is *{}*.
I'm a powerfull group management bot with a few fun extras! Have a look at the following for an idea of some of the things I can help you with. """.format(
